...
namespace Gley.DailyRewards.Internal
{
    public class CalendarPopup : MonoBehaviour
    {
        ...
        private void RefreshText()
        {
            ...
            {
                subtitleText.text = Gley.Localization.API.GetText(WordIDs.UIDailyReward_subtitle1);
                remainingTime.text = CalendarManager.Instance.GetRemainingTime();
            }
            else
            {
                subtitleText.text = Gley.Localization.API.GetText(WordIDs.UIDailyReward_subtitle2);
