...
public class ServerDataTable : MonoSingleton<ServerDataTable>
{
	...
	{
      //  Debug.Log("JellyBlast ServerDataTable.LoadGameLevelDataFromLocalFile");
			...
			if (fileContents.Length > 10 && fileContents.Substring(0, 10).StartsWith("{\"game"))
			{
				try
				{
					...
					if (resPacketLoadGameData != null)
					{
                        ...
                        //Debug.Log("JellyBlast ServerDataTable.LoadGameLevelDataFromLocalFile totalLevel1:" + resPacketLoadGameData.game.Length);
                    }
                }
				catch (Exception ex)
				{
                    Debug.Log("JellyBlast ServerDataTable.LoadGameLevelDataFromLocalFile ex:" + ex.Message);
                }
            }
			else
			{
				...
				if (array != null)
				{
                    ...
                    //Debug.Log("JellyBlast ServerDataTable.LoadGameLevelDataFromLocalFile totalLevel2:" + array.Length);
                }
            }
			return true;
		}
	...
	{
       // Debug.Log("JellyBlast ServerDataTable.LoadGameMapDataFromLocalFile");
		...
		if (!string.IsNullOrEmpty(fileContents))
		{
			if (fileContents.Length > 10 && fileContents.Substring(0, 10).StartsWith("{\"map"))
			{
				...
				{
                   // Debug.Log("JellyBlast ServerDataTable.LoadGameMapDataFromLocalFile ex:" + ex.Message);
                }
            }
			else
			{
