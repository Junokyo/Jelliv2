...
public class LocalDataManager
{
    ...
    public static string GetFileContents(string fileName, bool onlyPersistentPath = false)
    {
        ...
        if (File.Exists(path))
        {
            ...
            catch (Exception ex)
            {
                text = null;
                File.Delete(path);
                Debug.Log("JellyBlast LocalDataManager.GetFileContents MemoryStream ex: " + ex.Message);
            }
            }
        }
        if (string.IsNullOrEmpty(text))
        {
           // Debug.Log("JellyBlast LocalDataManager.GetFileContents start fileName:" + fileName);
            ...
            {
                Debug.Log("JellyBlast LocalDataManager.GetFileContents ex: " + ex.Message);
            }
        }
       // Debug.Log("JellyBlast LocalDataManager.GetFileContents end fileName:" + fileName);
        return text;
    }
    ...
    public static void SaveFile(bool isResourcesFolder, string fileName, string jsonData)
    {
        ...
        {
            Debug.Log("JellyBlast LocalDataManager.SaveFile ex: " + ex.Message);
        }
    }
