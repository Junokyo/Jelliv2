...
public class CPanelGameUI : CPanel
{
	...
	public GameObject ObjTouchToSkipEndBonusTime;
	...
	public void Start()
	{
		...
		ObjTouchToSkipEndBonusTime.SetActive(value: false);
	...
	public void OnPressTouchToSkipGameEndBonus()
	{
		ObjTouchToSkipEndBonusTime.SetActive(value: false);
		GameMain.main.SkipGameEndBonus();
	}
}
